...
-- Χρόνος δημιουργίας: 11 Ιουν 2022 στις 03:51:47
...
(2, '2022-06-07 02:45:16', 11, 'Dimtiris Thomopoulos', 'thomopoulos59@gmail.com', 'Perfect game! 10/10'),
(3, '2022-06-11 03:34:25', 24, 'Dimtiris Thomopoulos', 'thomopoulos59@gmail.com', 'dawdwad');
...
--
ALTER TABLE `games`
  MODIFY `game_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=180;
COMMIT;
